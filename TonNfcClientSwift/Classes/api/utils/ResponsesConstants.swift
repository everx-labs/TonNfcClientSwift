...
public class ResponsesConstants {
    ...
    static let ERROR_TYPE_IDS = [CARD_ERROR_TYPE_ID, SWIFT_INTERNAL_ERROR_TYPE_ID, IOS_NFC_ERROR_TYPE_ID, INPUT_DATA_FORMAT_ERROR_TYPE_ID, CARD_RESPONSE_DATA_ERROR_TYPE_ID, IMPROPER_APPLET_STATE_ERROR_TYPE_ID, HMAC_KEY_ERROR_TYPE_ID]
    ...
    static let ERROR_TYPE_NAMES = [CARD_ERROR_TYPE, SWIFT_INTERNAL_ERROR_TYPE, IOS_NFC_ERROR_TYPE, INPUT_DATA_FORMAT_ERROR_TYPE, CARD_RESPONSE_DATA_ERROR_TYPE, IMPROPER_APPLET_STATE_ERROR_TYPE, HMAC_KEY_ERROR_TYPE]
    ...
    static let ERROR_TYPE_MSGS = [CARD_ERROR_TYPE_MSG, SWIFT_INTERNAL_ERROR_TYPE_MSG, IOS_NFC_ERROR_TYPE_MSG, INPUT_DATA_FORMAT_ERROR_TYPE_MSG, CARD_RESPONSE_DATA_ERROR_TYPE_MSG, IMPROPER_APPLET_STATE_ERROR_TYPE_MSG, HMAC_KEY_ERROR_TYPE_MSG]
    ...
    static let ERROR_MSG_PIN_BYTES_SIZE_INCORRECT: String =  "Pin byte array must have length " + String(TonWalletAppletConstants.PIN_SIZE) + "."
    ...
    */
    ...
    static let IOS_NFC_ERRORS = [ERROR_MSG_NFC_SESSION_IS_NIL, ERROR_MSG_NFC_TAG_NOT_DETECTED, ERROR_MSG_NFC_TAG_NOT_CONNECTED]
    ...
    static let ERROR_MSG_PIN_LEN_INCORRECT: String =  "Pin must be a numeric string of length " + String(TonWalletAppletConstants.PIN_SIZE) + "."
    ...
    static let INPUT_DATA_FORMAT_ERRORS = [ERROR_MSG_PASSWORD_LEN_INCORRECT, ERROR_MSG_COMMON_SECRET_LEN_INCORRECT, ERROR_MSG_INITIAL_VECTOR_LEN_INCORRECT,
                                           ERROR_MSG_PASSWORD_NOT_HEX, ERROR_MSG_COMMON_SECRET_NOT_HEX, ERROR_MSG_INITIAL_VECTOR_NOT_HEX, ERROR_MSG_PIN_LEN_INCORRECT, ERROR_MSG_PIN_FORMAT_INCORRECT, ERROR_MSG_DATA_FOR_SIGNING_NOT_HEX,
                                           ERROR_MSG_RECOVERY_DATA_NOT_HEX, ERROR_MSG_RECOVERY_DATA_LEN_INCORRECT, ERROR_MSG_HD_INDEX_LEN_INCORRECT, ERROR_MSG_HD_INDEX_FORMAT_INCORRECT, ERROR_MSG_DEVICE_LABEL_LEN_INCORRECT,
                                           ERROR_MSG_DEVICE_LABEL_NOT_HEX, ERROR_MSG_KEY_HMAC_LEN_INCORRECT, ERROR_MSG_KEY_HMAC_NOT_HEX, ERROR_MSG_KEY_NOT_HEX, ERROR_MSG_KEY_LEN_INCORRECT, ERROR_MSG_KEY_SIZE_INCORRECT,
                                           ERROR_MSG_NEW_KEY_LEN_INCORRECT, ERROR_MSG_KEY_INDEX_VALUE_INCORRECT,
                                           ERROR_MSG_KEY_INDEX_STRING_NOT_NUMERIC, ERROR_MSG_SERIAL_NUMBER_LEN_INCORRECT, ERROR_MSG_SERIAL_NUMBER_NOT_NUMERIC]
    ...
    static let ERROR_MSG_OCCUPIED_SIZE_RESPONSE_INCORRECT: String = "Occupied size of keys can not be negative"
    static let ERROR_MSG_FREE_SIZE_RESPONSE_INCORRECT: String = "Free size of keys can not be negative"
    static let ERROR_MSG_GET_KEY_INDEX_IN_STORAGE_AND_LEN_RESPONSE_LEN_INCORRECT: String =  "Response from ET_KEY_INDEX_IN_STORAGE_AND_LEN card operation must have length " + String(TonWalletAppletConstants.GET_KEY_INDEX_IN_STORAGE_AND_LEN_LE) + "."
    ...
    static let ERROR_MSG_AFTER_NUM_OF_KEYS_INCORRECT_AFTER_ADD: String = "After ADD_KEY card operation number of keys must be increased by 1."
    static let ERROR_MSG_AFTER_NUM_OF_KEYS_INCORRECT_AFTER_CHANGE: String = "After ADD_KEY card operation number of keys must not be changed."
    ...
    static let CARD_RESPONSE_DATA_ERRORS = [ERROR_MSG_SAULT_RESPONSE_LEN_INCORRECT, ERROR_MSG_STATE_RESPONSE_LEN_INCORRECT, ERROR_MSG_STATE_RESPONSE_INCORRECT,
                                            ERROR_MSG_RECOVERY_DATA_HASH_RESPONSE_LEN_INCORRECT, ERROR_MSG_RECOVERY_DATA_LENGTH_RESPONSE_LEN_INCORRECT, ERROR_MSG_RECOVERY_DATA_LENGTH_RESPONSE_INCORRECT, ERROR_IS_RECOVERY_DATA_SET_RESPONSE_LEN_INCORRECT,
                                            ERROR_MSG_HASH_OF_ENCRYPTED_PASSWORD_RESPONSE_LEN_INCORRECT, ERROR_MSG_HASH_OF_ENCRYPTED_COMMON_SECRET_RESPONSE_LEN_INCORRECT, ERROR_MSG_HASH_OF_ENCRYPTED_COMMON_SECRET_RESPONSE_INCORRECT,
                                            ERROR_MSG_HASH_OF_ENCRYPTED_PASSWORD_RESPONSE_INCORRECT, ERROR_MSG_SIG_RESPONSE_LEN_INCORRECT, ERROR_MSG_PUBLIC_KEY_RESPONSE_LEN_INCORRECT, ERROR_MSG_GET_NUMBER_OF_KEYS_RESPONSE_LEN_INCORRECT,
                                            ERROR_MSG_NUMBER_OF_KEYS_RESPONSE_INCORRECT, ERROR_MSG_GET_OCCUPIED_SIZE_RESPONSE_LEN_INCORRECT, ERROR_MSG_GET_FREE_SIZE_RESPONSE_LEN_INCORRECT, ERROR_MSG_OCCUPIED_SIZE_RESPONSE_INCORRECT,
                                            ERROR_MSG_FREE_SIZE_RESPONSE_INCORRECT, ERROR_MSG_GET_KEY_INDEX_IN_STORAGE_AND_LEN_RESPONSE_LEN_INCORRECT, ERROR_MSG_KEY_INDEX_INCORRECT, ERROR_MSG_KEY_LENGTH_INCORRECT,
                                            ERROR_MSG_DELETE_KEY_CHUNK_RESPONSE_LEN_INCORRECT, ERROR_MSG_DELETE_KEY_CHUNK_RESPONSE_INCORRECT, ERROR_MSG_DELETE_KEY_RECORD_RESPONSE_LEN_INCORRECT, ERROR_MSG_DELETE_KEY_RECORD_RESPONSE_INCORRECT,
                                            ERROR_MSG_GET_DELETE_KEY_CHUNK_NUM_OF_PACKETS_RESPONSE_LEN_INCORRECT, ERROR_MSG_GET_DELETE_KEY_CHUNK_NUM_OF_PACKETS_RESPONSE_INCORRECT, ERROR_MSG_GET_DELETE_KEY_RECORD_NUM_OF_PACKETS_RESPONSE_LEN_INCORRECT,
                                            ERROR_MSG_GET_DELETE_KEY_RECORD_NUM_OF_PACKETS_RESPONSE_INCORRECT, ERROR_MSG_AFTER_NUM_OF_KEYS_INCORRECT_AFTER_ADD, ERROR_MSG_AFTER_NUM_OF_KEYS_INCORRECT_AFTER_CHANGE, ERROR_MSG_SEND_CHUNK_RESPONSE_LEN_INCORRECT,
                                            ERROR_MSG_GET_HMAC_RESPONSE_LEN_INCORRECT, ERROR_MSG_INITIATE_DELETE_KEY_RESPONSE_LEN_INCORRECT, ERROR_MSG_GET_SERIAL_NUMBER_RESPONSE_LEN_INCORRECT,
    ...
    static let IMPROPER_APPLET_STATE_ERRORS = [ERROR_MSG_APDU_NOT_SUPPORTED, ERROR_MSG_APPLET_DOES_NOT_WAIT_AUTHORIZATION, ERROR_MSG_APPLET_IS_NOT_PERSONALIZED,
    ...
    static let ERROR_MSG_UNABLE_RETRIEVE_ANY_KEY_FROM_IOS_KEYCHAIN: String = "Unable to retrieve any keys from keychain"
    ...
    static let HMAC_KEY_ERRORS = [ERROR_MSG_KEY_FOR_HMAC_DOES_NOT_EXIST_IN_IOS_KEYCHAIN, ERROR_MSG_CURRENT_SERIAL_NUMBER_IS_NOT_SET_IN_IOS_KEYCHAIN, ERROR_MSG_UNABLE_RETRIEVE_ANY_KEY_FROM_IOS_KEYCHAIN,
        ERROR_MSG_UNABLE_RETRIEVE_KEY_INFO_FROM_IOS_KEYCHAIN]
    
    static let ALL_NATIVE_ERROR_MESSAGES = [SWIFT_INTERNAL_ERRORS, IOS_NFC_ERRORS, INPUT_DATA_FORMAT_ERRORS, CARD_RESPONSE_DATA_ERRORS, IMPROPER_APPLET_STATE_ERRORS, HMAC_KEY_ERRORS]
