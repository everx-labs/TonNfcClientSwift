...
For each NFC card operation there is a function in TonNfcClientSwift API. These functions use callbacks mechanism to output results of work into caller. We defined NfcCallback class for this.
